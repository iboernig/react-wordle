...
export const InfoModal = ({ isOpen, handleClose }: Props) => {
  return (
    <BaseModal title="So funktioniert's:" isOpen={isOpen} handleClose={handleClose}>
      <p className="text-sm text-gray-500 dark:text-gray-300">
        Errate das Wort des Tages in 6 Versuchen. 
        Nach jedem Versuch wird mit Farben angezeigt, wie nah dein Wort der Lösung war:
      </p>
      ...
      <p className="mt-6 text-sm italic text-gray-500 dark:text-gray-300">
        Jeden Tag um Mitternacht wird ein neues Wörtchen freigeschaltet. Den Quellcode findet ihr 
        <a
          href="https://github.com/iboernig/react-wordle"
